...
class KnowledgeAllArticles extends Component {
  constructor(props) {
    super(props)
    this.state = {
      active: false,
          ...
          <Row className="row-fluid">
            ...
            <Col md={2} xl={4} offsetXl={1} className="col-right">
              <div className="image-holder">
                <img src={graphicLibrarySmall} alt="Academy" />
              </div>
            </Col>
          </Row>
        </Container>
  ...
  render() {
    const { sidebar, error, fetching, t, lang } = this.props
...
const mapDispatchToProps = dispatch => {
  return {
    moreArticles: (slug, tag, sortby, orderby) =>
      dispatch(Creators.request(slug, tag, sortby, orderby)),
...
KnowledgeAllArticles = connect(mapStateToProps, mapDispatchToProps)(KnowledgeAllArticles)
export default translate()(KnowledgeAllArticles)
